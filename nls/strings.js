define({
  root: ({
    ...
    "successfullyPublished": "Successfully published web layer",
    "successfullyAppended": "Successfully appended new features to web layer",
    "manageWebLayerText": "Manage the web layer",
